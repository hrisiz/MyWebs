<?php
	if (isset($_POST['add_question']))
	{
		...
		else
		{
			...
			{
				$query_code = "Insert Into Questions values('".$_POST['Question']."','".$_POST['Answer_1']."','".$_POST['Answer_2']."','".$_POST['Answer_3']."','".$_POST['Answer_4']."','".$_POST['Answer_1']."',".$_POST['Points'].",'$account')";
				file_put_contents("Insert.txt",$query_code."\r\n",FILE_APPEND);
				mssql_query($query_code);
