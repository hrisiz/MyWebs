...
<tr><td rowspan="9" colspan="2"><img height="200px" src="images/<?=$all_races_short_name[$char_info['Class']]?>.jpg" alt="Class Picture" /></td><td>Name:</td><td><?=$char?></td></tr>
...
<tr><td>Last Connect:</td><td><?=date("d/m/Y H:i", strtotime($char_info_for_acc['ConnectTM'])) ?></td><td>GrandResets:</td><td><?=$char_info['GrandResets'] ?></td></tr>
<tr><td>Last Disconnect:</td><td><?=date("d/m/Y H:i", strtotime($char_info_for_acc['DisConnectTM'])) ?></td><td>Bonus Points:</td><td><?=intval($char_info['BonusPoints']) ?></td></tr>
<tr><td>Tatal Online Time:</td><td><?=get_time($char_info_for_acc['TotalTime'])  ?></td><td>Kills:</td><td><?=$char_info['PkCount'] ?></td></tr>
<tr><td>Week Online Time:</td><td><?=get_time($char_info['WeekOnlineTime']) ?></td><td>Quest:</td><td><?=$char_info['QuestNumber'] ?></td></tr>
</table>