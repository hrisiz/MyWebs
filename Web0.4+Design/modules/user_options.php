...
<ul class="hor_nav">
  ...
  <li>Stones
    <ul class="ver_nav">
      ...
      <a onclick="startLoading()" href="/?page=Modules_User-Panel_Stones_Change-Race"><li>Change Race</li></a>
      <a onclick="startLoading()" href="/?page=Modules_User-Panel_Stones_Clear-Stats"><li>Clear Stats</li></a>
