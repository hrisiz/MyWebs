<?php
  ...
  $grizismudb->exec("Update MEMB_INFo Set bloc_code=1 Where memb_guid=".$_GET['accid']."");
  $grizismudb->exec("Update Character Set CtlCode=1 Where AccountId='".$acc_info['memb___id']."'");
  sleep(1);
