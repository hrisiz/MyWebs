...
if(isset($_POST['AddPoints'])){
	...
	$char_info = $grizismudb->query("Select Name,LevelUpPoint From Character Where Name='$character' AND AccountId='$account'")->fetchAll();
...
<form Method="POST">
	...
	<input onclick="startLoading()" type="submit" name="AddPoints" value="Add"/>
</form>