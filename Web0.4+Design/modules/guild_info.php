...
$characters = $grizismudb->query("Select Character.Name,Character.Resets,Character.cLevel,Character.Class,Character.AccountId From GuildMember,Character Where Character.Name=GuildMember.Name AND GuildMember.G_Name = '$guild' Order By Character.Resets desc,Character.cLevel desc")->fetchAll();
