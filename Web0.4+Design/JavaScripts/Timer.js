...
function start_timer(){
  ...
  // document.getElementById("stat_timer").innerHTML = start_timer/24/60/60
  stat_timer_play(start_timer,"stat_timer");
  setInterval(function(){stat_timer_play(start_timer--,"stat_timer");},1000);
}