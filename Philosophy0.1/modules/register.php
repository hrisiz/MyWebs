...
{
	if(Count($questions->query("Select * From Users Where User_Name = '".$_POST['username']."'")->fetchAll()) > 0){
		...
		$questions->exec("Insert Into Users values('".$_POST['username']."',"."0x".md5($_POST['password']).",'".$_POST['e-mail']."','".$_POST['squestion']."','".$_POST['sanswer']."',0,'0','".$_SERVER['REMOTE_ADDR']."')");
