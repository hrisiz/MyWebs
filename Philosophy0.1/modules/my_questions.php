...
if(isset($_POST['Delete'])){
	$question_info = $questions->query("Select * From Questions Where ID=".$_POST['question_id'])->fetchAll();
	...
	$questions->exec("Delete From Questions Where ID=".$_POST['question_id']);
}
if(isset($_POST['edit_question'])){
	...
	else
	{
		...
		{
			$questions->exec("Update Questions Set Question='".$_POST['Question']."',Answer_1='".$_POST['Answer_1']."',Answer_2='".$_POST['Answer_2']."',Answer_3='".$_POST['Answer_3']."',Answer_4='".$_POST['Answer_4']."',Correct_Answer='".$_POST['Answer_1']."' Where ID=".$_POST['question_id']."");
...
<?php 
	$my_questions = $questions->query("Select * From Questions Where User_Name='$account'")->fetchAll();
	$i = 1;
