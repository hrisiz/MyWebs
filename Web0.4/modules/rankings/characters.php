...
<table class="ranking">
	...
	<?php
		...
		{			
			...
			echo"<tr><td>$i</td><td><a href=\"?page=Modules_Character-Info&CharacterName=$char[0]\">$char[0]</a></td><td>$char[1]/$char[2]</td><td>".$all_races_name[$char['Class']]."</td><td>$guild</td><td>$status</td></tr>";
			$i++;
		}
	?>
</table>